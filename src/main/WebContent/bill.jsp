...
<hr>
<div class="left-div"><h3>Name:  <%=rs2.getString(1) %>  <%=rs2.getString(2) %></h3></div>
<div class="right-div-right"><h3>Email:  <%out.println(email); %></h3></div>
<div class="right-div"><h3>Mobile Number:  <%=rs2.getString(12) %></h3></div>  

<div class="left-div"><h3>Order Date:  <%=rs2.getString(13) %></h3></div>
<div class="right-div-right"><h3>Payment Method:  <%=rs2.getString(15) %></h3></div>
<div class="right-div"><h3>Expected Delivery:  <%=rs2.getString(14) %></h3></div> 
