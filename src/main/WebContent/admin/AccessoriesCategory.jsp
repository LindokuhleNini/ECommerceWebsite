...
try{
   Connection con=ConnectionProvider.getCon();
    ...
    ResultSet rs = st.executeQuery("select *from products where category='accessories' and active='Yes'");
    while(rs.next())
    {
    %>
        <div id="card" class="card" style="width: 10rem;">
            ...
            <div id="cardBody" class="card-body d-flex flex-column">
              ...
              <a href="#" id="test" class="btn btn-primary shop-item-button mt-auto">Edit</a>
            </div>
          </div>
